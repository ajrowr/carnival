window.FCScene = (function () {
    ...
    Scene.prototype.moveFloorAndPlayerTo = function (loc, tween) {
        if (tween) {
        ...
        this.getObjectByLabel('floor').relocateTo(loc);
    ...
    Scene.prototype.prepareObject = function (obj) {
        ...
        if (objDat.vertices && objDat.indices) {
            ...
            gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(objDat.indices), gl.STATIC_DRAW);
    ...
    Scene.prototype._renderObjectFace = function (sO, projectionMat, modelViewMat, pov, renderState) {
        ...
        var baseColor;
        if (sO.baseColor || sO.parent.baseColor) {
