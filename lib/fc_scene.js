window.FCScene = (function () {
    ...
    Scene.prototype._renderObjectFace = function (sO, projectionMat, modelViewMat, pov, renderState) {
        ...
        var xNormalMat = mat4.create();
        // mat4.clone(xNormalMat, mVM);
        // xNormalMat = mat4.clone(mVM);
        var modelTrans = vec3.create();
        var modelRot = quat.create();
        mat4.getTranslation(modelTrans, modelMat);
        mat4.getRotation(modelRot, modelMat);
        
        mat4.fromRotationTranslation(xNormalMat, modelRot, modelTrans);
        // mat4.fromQuat(xNormalMat, modelRot);
        // console.log(xNormalMat);
        
        
        // normalMat = mat4.clone(modelMat);
        ...
        var clonedNormalMat = mat4.clone(modelMat);
        var vecScale = 1/(sO.scaleFactor||1);
        mat4.scale(clonedNormalMat, clonedNormalMat, [vecScale, vecScale, vecScale]);
        
        // normalMat = altNormalMat;
        
        var normalMat;
        if (sO.DEBUGGING) {
            normalMat = xNormalMat;
        }
        else {
            normalMat = clonedNormalMat;
        ...
        //     console.log(normalMat);
        // }
        sO.debug = {xNormalMat: xNormalMat, clonedNormalMat: clonedNormalMat};
        ...
        if (sO.mesh) {
            ...
            gl.drawElements(sO.drawMode || gl.TRIANGLES, num, gl.UNSIGNED_INT, 0);
            ...
            gl.drawElements(sO.drawMode || gl.TRIANGLES, sO.idxCount, gl.UNSIGNED_INT, 0);
        }
    }
