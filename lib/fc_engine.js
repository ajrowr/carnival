  ...
  navigator.getVRDisplays().then(function (displays) {
    if (displays.length > 0) {
      ...
      window.START_VR = function () {
          ...
          if (poseMissing) {
              error('Gamepads were detected but are not reporting a pose. You probably need to enable Gamepad Extensions in about:flags . <a style="color:green;" href="http://meta4vr.net/setup/">Click here for the solution</a>');
          }
