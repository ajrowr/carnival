...
window.FCPrimitives = (function () {
    ...
    var Drawable = function (pos, size, orientation, params) {
        ...
        this.rotationQuaternion = p.rotationQuaternion || null;
        ...
        this.behaviors = {}; /* We're gonna be transitioning anyways :-} */
        this._behaviorList = []; /* for internal use. we address them using behaviors but this is for the engine */
        this.interactions = {};
    ...
    Drawable.prototype.addBehavior = function (behavior, label) {
        let myBehavior = null;
        if (typeof behavior == 'object') {
            label = behavior.label;
            myBehavior = behavior.function;
        }
        else myBehavior = behavior;
        if (label) this.behaviors[label] = myBehavior;
        this._behaviorList.push(myBehavior);
        this.behaviours.push(myBehavior); /* transitional TODO */
        
    }
    
    Drawable.prototype.removeBehavior = function (label) {
        var b = this.behaviors[label];
        this._behaviorList.splice(this._behaviorList.indexOf(b), 1);
        this.behaviours.splice(this.behaviours.indexOf(b), 1);
    }
    
    Drawable.prototype.advanceSimulation = function (timePoint, actorsInProximity) {
        var dr = this;
        if (this._behaviorList) {
            this._behaviorList.forEach(function (b) {
                b(dr, timePoint);
                dr.latestMoment = timePoint;
            })
        }
        else if (this.behaviours) {
    ...
    Drawable.prototype.interact = function (interactionType, params) {
        /* select, deselect, activate, context, lookAt, focusOn, focusOff, grab, swipe, throw ... */
...
window.FCShapes = (function () {
    ...
    var SimpleCuboid = function (pos, sz, rotate, params) {
        var size = {
            w: sz && (sz.w || sz.width) || 1,
            h: sz && (sz.h || sz.height) || 1,
            d: sz && (sz.d || sz.depth) || 1,
        }
    ...
    /* .. probably something to do with mesh being injected from elsewhere? */
    /* yeah. This one is compatible with standard component constructors, the other isn't */
    var MeshShape2 = function (pos, size, rotate, params) {
        // this.mesh = mesh;
        var sz = size || {};
        this.scaleFactor = sz.scale || 1.0;        
    ...
    MeshShape2.prototype = Object.create(P.Drawable.prototype);
    MeshShape2.prototype.divulge = function () {
        return {};
    }
    shapeTypes['MeshShape2'] = MeshShape2;
    ...
    var WallShape2 = function (pos, size, rotate, params) {
        P.Drawable.call(this, pos, size, rotate, params);
        var p = params || {};
        var sz = size || {};
        this.segmentsX = p.segmentsX || 1;
        this.segmentsY = p.segmentsY || 1;
    ...
    WallShape2.prototype = WallShape.prototype;
    shapeTypes['WallShape2'] = WallShape2;
    ...
    /* size = {radius:R, height:H, topRadius, bottomRadius} */
    ...
    var LatheExtruderShape = function (pos, size, rotate, params) {
        ...
        this.profile = {
            ...
            points: p.profile && p.profile.points || p.profilePoints || null,
    ...
    LatheExtruderShape.prototype.profileSamplers = {
    }
    
    LatheExtruderShape.prototype.shapeSamplers = {
        Circle: function () {
            return function (j, n) {
                var frac = j/n;
    ...
    LatheExtruderShape.prototype.divulge = function () {
        ...
        var profileSampler = lathe.profileSampler || lathe.profile.sampler || samplerType(lathe.profile.points);
        ...
        for (var i=0; i<lathe.profile.segmentCount; i++) {
            ...
            var ylo = segmentHeight * i, yhi = segmentHeight * (i+1);
            var anglePer = (2*Math.PI)/this.segmentCount; //
            var r1 = profileSampler(i, lathe.profile.segmentCount);
            var r2 = profileSampler(i+1, lathe.profile.segmentCount);
            var s = this.scale;
